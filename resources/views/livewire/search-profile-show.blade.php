<div class="px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-md p-6 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <!-- Genre Filter -->
            <div>
                <label for="genre" class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-2">Genre</label>
                <flux:select wire:model.live="selectedGenre" placeholder="All Genres">
            ...
            <!-- News Outlet Filter -->
            <div>
                <label for="outlet" class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-2">News Outlet</label>
                <flux:select wire:model.live="selectedNewsOutlet" placeholder="All News Outlets">
