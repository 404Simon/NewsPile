                ...
                <div
                    ...
                    <div class="p-6">
                        <div class="flex justify-between items-start">
                            <h2 class="text-xl font-bold text-zinc-900 dark:text-white truncate">{{ $profile->name }}
                            </h2>
                            <div class="flex">
                                ...
                                <button type="button" wire:click="deleteProfile({{ $profile->id }})" wire:confirm="Are you sure?"
